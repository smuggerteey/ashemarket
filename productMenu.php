	...
	<body class>
		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
				<div class="container">
						<h2>Welcome to Ashesi Market Place</h2>
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="clothes" style="color: black;">Clothes</option>
										<option value="stationey" style="color: black;">Stationery</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
				...
				<?php
				    ...
				    if(isset($_GET['type']) AND $_GET['type'] == "food")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Food'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "clothes")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Clothes'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "stationery")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Stationery'";
					}
